...
\begin{figure}[t]
  ...
  \begin{tabular}{l r r r r}
    ...
    Intercept & 0.16099 & 0.0361 & 4.452 & <0.001*\\
    Exposures & 0.42065 & 0.2025 & 2.077 & <0.05* \\
    \hline
  ...
  \begin{tabular}{l r r r r}
    \hline
    Predictor & $\beta$ & Std Error & $t$ & $p$ \\ \hline
    Intercept & 0.09899 & 0.0380 & 2.600 & <0.05*\\
    Exposures & 0.49295 & 0.2131 & 2.312 & <0.05* \\
    \hline
    \multicolumn{5}{l}{\T $R^2$ = 0.03, $F$(1, 149) = 5.34 \T}\\
  \end{tabular}
  \vskip 1em

  \textbf{Referent assignment}\\
  \begin{tabular}{l r r r r}
    \hline
    Predictor & $\beta$ & Std Error & $t$ & $p$ \\ \hline
    Intercept & 0.24805 & 0.0612 & 4.053 & <0.001*\\
    Exposures & 0.89587 & 0.3487 & 2.568 & <0.05* \\
    \hline
    \multicolumn{5}{l}{\T $R^2$ = 0.04, $F$(1, 147) = 0.04 \T}\\
  \end{tabular}  
  \caption{Regression models from Experiment 1b.}
...
As in Experiment 1a, we computed an ordering on the sentence types in the memory task: F > W $\approx$ C > P. This indicates that participants were able to learn some regularities in the language, but not the co-occurrence regularities.
