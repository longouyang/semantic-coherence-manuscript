...
Figure~\ref{x1-descriptive-mem} shows mean familiarity ratings broken down by sentence type, coherence, and exposures. Within each coherence level, we looked for evidence of a difficulty ordering on sentence types. Thus, we used non-orthogonal contrasts examining the difference between (1) pair-violation and co-occurrence violation sentences, (2) co-occurrence violation and withheld sentences, and (3) withheld and familiar sentences.

patterns in sem0: familiar = withheld = co-occurrence violation > position violation
