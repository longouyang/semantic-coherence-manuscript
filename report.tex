...
\begin{table}[ht]
  \caption{Regression model for Experiment 1a. For readability, we divided the exposure values by 1,000.}
...
\begin{table}[t]
  \caption{Regression model for Experiments 2 and 3. For readability, we divided exposure values by 1,000.}
