...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Mean familiarity ratings for different sentence types in Experiments 2 and 3. For comparison with Experiment 1, we also present results from the 3/3 coherence condition.}
