...
\subsubsection{Design and Procedure}
The method was identical to that of Experiment 1a.
...
\begin{figure}[h]
  \begin{center}
    ...
    \end{tabular}
    \caption{$p$ values for paired-sample t-tests of familiarity ratings for (F)amiliar, (W)ithheld, (C)o-occurrence violation, and (P)osition violation sentences in Experiments 1a, 2, and 3. $p$ values have been adjusted for multiple comparisons using the Holm procedure.}
