...
\subsubsection{Descriptive statistics for the memory task}
Fig.~\ref{x1-descriptive-mem} shows mean familiarity ratings broken down by sentence type, coherence, and exposures. As in Experiment 1a, we used Holm-corrected pairwise t-tests to compute a familiarity ordering on sentence types (Fig.~\ref{familiarity-ordering-t-tests}). The ordering for the nonce connective 3/3 condition was:
\begin{center}
  (F $\approx$ W) > C > P
\end{center}
...
Fig.~\ref{x23-descriptive-mem} shows mean familiarity ratings broken down by sentence type, coherence, and exposures. As in previous analyses, we computed a familiarity ordering on sentence types within each phonological coherence condition using paired sample t-tests (Fig.~\ref{familiarity-ordering-t-tests}):
...
F > W $\approx$ C > P
\end{center}
\noindent (see Fig.~\ref{familiarity-ordering-t-tests}). This indicates that participants were able to learn some regularities in the language, but not the co-occurrence regularities.
...
\begin{figure}
  \begin{center}
    \begin{tabular}{c c c}
      ...
      \textbf{0/3 coherence}: df = 150 & \textbf{1/3 coherence}: df = 153 & \textbf{2/3 coherence}: df = 164\\
      ...
      \textbf{3/3 coherence}: df = 152 & \textbf{Nonce coherence}: df = 150 & \textbf{Onset}: df = 150 \\
      ...
      \textbf{Rime}: df = 187 & \textbf{Syllable count}: df = 148 & \textbf{Semantic baseline}: df = 143 \\
