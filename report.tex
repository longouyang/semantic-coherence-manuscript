...
\begin{center}
  (F $\approx$ W) > C > P
\end{center}
\noindent Thus, participants who saw a version of the 3/3 language with ``and'' replaced by ``tezz'' successfully distinguished between novel grammatical (i.e., withheld) sentences and ungrammatical (i.e., co-occurrence violation) sentences. If results of Experiment 1a hinged on the use of the ``and'' connective, participants should not have been able to distinguish between withheld and co-occurrence violation sentences. \cas{talk about comparison to 2/3 and 3/3}
